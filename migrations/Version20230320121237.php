 ...
 */
final class Version20230320121237 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE enseigne (id INT AUTO_INCREMENT NOT NULL, formateur_id INT DEFAULT NULL, matiere_id INT NOT NULL, INDEX IDX_37D4778E155D8F51 (formateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE suivre (id INT AUTO_INCREMENT NOT NULL, formation_id INT NOT NULL, apprenants_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
